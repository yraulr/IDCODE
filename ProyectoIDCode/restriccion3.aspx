<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="restriccion3.aspx.cs" Inherits="ProyectoIDCode.restriccion3" %>
                        ...
                        <div class="col-lg-7">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <a href="#" style="margin-left: 5px" class="btn btn-primary btn-lg" role="button" data-toggle="modal" data-target="#myModal4">Finalizar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content animated fadeIn">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Matrícula 2016 Reservada</h4>
                                    <small>Usted ha reservado la Matricula del Alumno.</small>
                                </div>
                                <div class="modal-body">
                                    <p>Por esta misma vía se debe realizar el seguimiento respectivo del trámite, hasta que este sea evaluado (Procede o No Procede).</p>
                                </div>
